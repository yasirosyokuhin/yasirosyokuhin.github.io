...
function getHeaderDetail() {
	...
	//tag += '<table width="100%"><tbody><tr><th class="fixed01" width="10%">';;
	//tag += '血統</th><td width="60%">';
	//tag += factorlist[detailHorse.t -1].c_ped ;
	//tag += '</td>';
	//tag += '';
	//tag += '<th class="fixed01" width="10%">因子</th>';
	//if (detailHorse.factor != '') {		
	//	tag +=  '<td class="factor" width="50"><img src="static/img/rfactor_10.png" alt=""></td>';
	//	tag +=  '<td class="factor" width="50"><img src="static/img/rfactor_10.png" alt=""></td>';
	//} else {
	//	tag += '<td>なし</td>'
	//}
...
//<tr name="clickable-row" data-href="detail.html?horse='+ j_horse.id + '">
...
function getHeader() {
	...
	//tag += '<ul id="txt" class="list-group"></ul>';
    //tag += '<div class="tabmenu-head">';
	//tag += '	<div class="footer">';
	//tag += '		<label>';
	//tag += '		<input name="tab-head" id="0" type="radio" checked="" class="sei">';
	//tag += '		<em>種牡馬</em>';
	//tag += '		</label>';
	//tag += '		<label>';
	//tag += '		<input name="tab-head" id="1" type="radio" class="sei">';
	//tag += '		<em>牝馬</em>';
	//tag += '		</label>';
	//tag += '	</div>';
	//tag += '</div>';
...
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Na" id="t-Na" type="checkbox">';
//tag += '	     <label for="t-Na">Na</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="Ha" id="t-Ha" type="checkbox">';
//tag += '	     <label for="t-Ha">Ha</label>';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="St" id="t-St" type="checkbox">';
//tag += '	     <label for="t-St">St</label>';
//tag += '	     ';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="He" id="t-He" type="checkbox">';
//tag += '	     <label for="t-He">He</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Te" id="t-Te" type="checkbox">';
//tag += '	     <label for="t-Te">Te</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ph" id="t-Ph" type="checkbox">';
//tag += '	     <label for="t-Ph">Ph</label>';
//tag += '	 </div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ma" id="t-Ma" type="checkbox">';
//tag += '	     <label for="t-Ma">Ma</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Hi" id="t-Hi" type="checkbox">';
//tag += '	     <label for="t-Hi">Hi</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Sw" id="t-Sw" type="checkbox">';
//tag += '	     <label for="t-Sw">Sw</label>';
//tag += '	</div>';
//tag += '	 ';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Fa" id="t-Fa" type="checkbox">';
//tag += '	     <label for="t-Fa">Fa</label>';
//tag += '	</div>';
//tag += '	 ';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="To" id="t-To" type="checkbox">';
//tag += '	     <label for="t-To">To</label>';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="Ec" id="t-Ec" type="checkbox">';
//tag += '	     <label for="tt-Ec">Ec</label>';
//tag += '	 </div>';
//tag += '	 ';
//tag += '';
//tag += '		</span>';
...
//tag += '	';
//tag += '		<label>';
//tag += '	<input name="tab" type="radio" id="1">';
//tag += '			<em>父母父</em><span>';
//tag += '			';
//tag += '	';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="Ro" id="tht-Ro" type="checkbox">';
//tag += '	     <label for="tht-Ro">Ro</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ne" id="tht-Ne" type="checkbox">';
//tag += '	     <label for="tht-Ne">Ne</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ns" id="tht-Ns" type="checkbox">';
//tag += '	     <label for="tht-Ns">Ns</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Na" id="tht-Na" type="checkbox">';
//tag += '	     <label for="tht-Na">Na</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="Ha" id="tht-Ha" type="checkbox">';
//tag += '	     <label for="tht-Ha">Ha</label>';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="St" id="tht-St" type="checkbox">';
//tag += '	     <label for="tht-St">St</label>';
//tag += '	     ';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="He" id="tht-He" type="checkbox">';
//tag += '	     <label for="tht-He">He</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Te" id="tht-Te" type="checkbox">';
//tag += '	     <label for="tht-Te">Te</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ph" id="tht-Ph" type="checkbox">';
//tag += '	     <label for="tht-Ph">Ph</label>';
//tag += '	 </div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ma" id="tht-Ma" type="checkbox">';
//tag += '	     <label for="tht-Ma">Ma</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Hi" id="tht-Hi" type="checkbox">';
//tag += '	     <label for="tht-Hi">Hi</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Sw" id="tht-Sw" type="checkbox">';
//tag += '	     <label for="tht-Sw">Sw</label>';
//tag += '	</div>';
//tag += '	 ';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Fa" id="tht-Fa" type="checkbox">';
//tag += '	     <label for="tht-Fa">Fa</label>';
//tag += '	</div>';
//tag += '	 ';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="To" id="tht-To" type="checkbox">';
//tag += '	     <label for="tht-To">To</label>';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="Ec" id="tht-Ec" type="checkbox">';
//tag += '	     <label for="ttht-Ec">Ec</label>';
//tag += '	 </div>';
//tag += '';
//tag += '		</span>';
//tag += '		</label>';
//tag += '		<label>';
//tag += '			<input name="tab" id="3" type="radio">';
//tag += '			<em>母父</em>';
//tag += '			<span>';
//tag += '			';
//tag += '			';
//tag += '<div class="btn2_wrap">';
//tag += '	     <input value="Ro" id="ht-Ro" type="checkbox">';
//tag += '	     <label for="ht-Ro">Ro</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ne" id="ht-Ne" type="checkbox">';
//tag += '	     <label for="ht-Ne">Ne</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ns" id="ht-Ns" type="checkbox">';
//tag += '	     <label for="ht-Ns">Ns</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Na" id="ht-Na" type="checkbox">';
//tag += '	     <label for="ht-Na">Na</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="Ha" id="ht-Ha" type="checkbox">';
//tag += '	     <label for="ht-Ha">Ha</label>';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="St" id="ht-St" type="checkbox">';
//tag += '	     <label for="ht-St">St</label>';
//tag += '	     ';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="He" id="ht-He" type="checkbox">';
//tag += '	     <label for="ht-He">He</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Te" id="ht-Te" type="checkbox">';
//tag += '	     <label for="ht-Te">Te</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ph" id="ht-Ph" type="checkbox">';
//tag += '	     <label for="ht-Ph">Ph</label>';
//tag += '	 </div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ma" id="ht-Ma" type="checkbox">';
//tag += '	     <label for="ht-Ma">Ma</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Hi" id="ht-Hi" type="checkbox">';
//tag += '	     <label for="ht-Hi">Hi</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Sw" id="ht-Sw" type="checkbox">';
//tag += '	     <label for="ht-Sw">Sw</label>';
//tag += '	</div>';
//tag += '	 ';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Fa" id="ht-Fa" type="checkbox">';
//tag += '	     <label for="ht-Fa">Fa</label>';
//tag += '	</div>';
//tag += '	 ';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="To" id="ht-To" type="checkbox">';
//tag += '	     <label for="ht-To">To</label>';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="Ec" id="ht-Ec" type="checkbox">';
//tag += '	     <label for="tht-Ec">Ec</label>';
//tag += '	 </div>';
//tag += '	 ';
//tag += '		</span>';
//tag += '			';
...
//tag += '		';
//tag += '		<label>';
//tag += '			<input name="tab" type="radio" id="4">';
//tag += '			<em>母母父</em><span>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="Ro" id="hht-Ro" type="checkbox">';
//tag += '	     <label for="hht-Ro">Ro</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ne" id="hht-Ne" type="checkbox">';
//tag += '	     <label for="hht-Ne">Ne</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ns" id="hht-Ns" type="checkbox">';
//tag += '	     <label for="hht-Ns">Ns</label>';
//tag += '	</div>	';
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Na" id="hht-Na" type="checkbox">';
//tag += '	     <label for="hht-Na">Na</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="Ha" id="hht-Ha" type="checkbox">';
//tag += '	     <label for="hht-Ha">Ha</label>';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="St" id="hht-St" type="checkbox">';
//tag += '	     <label for="hht-St">St</label>';
//tag += '	     ';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="He" id="hht-He" type="checkbox">';
//tag += '	     <label for="hht-He">He</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Te" id="hht-Te" type="checkbox">';
//tag += '	     <label for="hht-Te">Te</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ph" id="hht-Ph" type="checkbox">';
//tag += '	     <label for="hht-Ph">Ph</label>';
//tag += '	 </div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Ma" id="hht-Ma" type="checkbox">';
//tag += '	     <label for="hht-Ma">Ma</label>';
//tag += '	</div>';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Hi" id="hht-Hi" type="checkbox">';
//tag += '	     <label for="hht-Hi">Hi</label>';
//tag += '	</div>';
//tag += '	';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Sw" id="hht-Sw" type="checkbox">';
//tag += '	     <label for="hht-Sw">Sw</label>';
//tag += '	</div>';
//tag += '	 ';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="Fa" id="hht-Fa" type="checkbox">';
//tag += '	     <label for="hht-Fa">Fa</label>';
//tag += '	</div>';
//tag += '	 ';
//tag += '	 <div class="btn2_wrap">';
//tag += '	     <input value="To" id="hht-To" type="checkbox">';
//tag += '	     <label for="hht-To">To</label>';
//tag += '	</div>';
//tag += '	<div class="btn2_wrap">';
//tag += '	     <input value="Ec" id="hht-Ec" type="checkbox">';
//tag += '	     <label for="thht-Ec">Ec</label>';
//tag += '	 </div>';
//tag += '			';
//tag += '			';
//tag += '			';
